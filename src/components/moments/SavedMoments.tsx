  ...
  return (
    <div className="bg-white rounded-2xl shadow-lg p-6">
      <div className="flex items-center gap-2 mb-4">
        ...
        <h3 className="font-bold text-lg">Saved Moments</h3>
      ...
      {moments.length === 0 ? (
        <p className="text-gray-400 text-sm">No saved moments yet. Save moments from the Explore page!</p>
      ) : (
        <div className="space-y-3 max-h-96 overflow-y-auto">
          {moments.map((moment) => (
            <div key={moment.id} className="flex items-center gap-3 p-2 rounded-xl hover:bg-gray-50 transition-colors">
              {moment.imageUrl ? (
              ...
              <div className="flex-1 min-w-0">
                <p className="text-sm font-medium text-gray-900 line-clamp-1">{moment.content}</p>
                {moment.place && (
