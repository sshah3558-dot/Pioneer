    ...
    <div className="animate-fade-in max-w-3xl mx-auto">
      ...
      <div className="flex items-center justify-between mb-6">
        <div className="flex items-center gap-3">
          ...
          <div>
            <h2 className="text-3xl font-bold gradient-text-135">My Rankings</h2>
            <p className="text-gray-500 text-sm">Your moments ranked by composite score</p>
          </div>
        </div>
        <button
          onClick={() => setShowCreateModal(true)}
          className="bg-gradient-to-r from-purple-600 to-pink-500 text-white px-5 py-2.5 rounded-xl font-bold hover:shadow-lg transition-all flex items-center gap-2"
        >
      ...
      {isLoading ? (
        ...
        <div className="bg-white rounded-2xl shadow-lg p-12 text-center">
          ...
          <p className="text-gray-500 text-lg font-medium">No moments yet</p>
          <p className="text-gray-400 text-sm mt-1">Create your first moment to start ranking your experiences!</p>
          <button
            onClick={() => setShowCreateModal(true)}
